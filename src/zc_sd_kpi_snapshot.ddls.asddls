  ...
  as projection on ZI_SD_KPI_SNAPSHOT
{
  key SnapshotUUID,
      ...
      @UI.dataPoint: { title: 'CA du mois', criticality: #POSITIVE }
      ...
      @UI.dataPoint: { title: 'Livraisons en retard', criticality: #NEGATIVE }
      ...
      @UI.dataPoint: { title: 'Factures en attente', criticality: #CRITICAL }
      ...
      @UI.dataPoint: { title: 'Blocages credit', criticality: #NEGATIVE }
      ...
      @UI.dataPoint: { title: 'Taux de service', criticality: #POSITIVE }
