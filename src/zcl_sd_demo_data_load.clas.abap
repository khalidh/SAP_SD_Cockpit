CLASS zcl_sd_demo_data_load DEFINITION
  ...
  PRIVATE SECTION.
    CLASS-METHODS uuid
      IMPORTING iv_uuid TYPE csequence
...
CLASS zcl_sd_demo_data_load IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    lt_sales_orders = VALUE #(
      (
        order_uuid = uuid( '22222222222222222222222222222281' )
        order_id = '5000012481'
      ...
      (
        order_uuid = uuid( '22222222222222222222222222222507' )
        order_id = '5000012507'
        sales_doc_type = 'OR - Commande standard'
      ...
      (
        order_uuid = uuid( '22222222222222222222222222222553' )
        order_id = '5000012553'
        sales_doc_type = 'OR - Commande standard'
      ...
      (
        order_uuid = uuid( '22222222222222222222222222222609' )
        order_id = '5000012609'
        sales_doc_type = 'OR - Commande standard'
    ...
    lt_sales_order_items = VALUE #(
      (
        item_uuid = uuid( '33333333333333333333333333333310' )
        parent_uuid = uuid( '22222222222222222222222222222281' )
        item_no = '10'
        material = 'MAT-100024'
      ...
      (
        item_uuid = uuid( '33333333333333333333333333333320' )
        parent_uuid = uuid( '22222222222222222222222222222281' )
        item_no = '20'
        material = 'MAT-200481'
      ...
      (
        item_uuid = uuid( '33333333333333333333333333333330' )
        parent_uuid = uuid( '22222222222222222222222222222507' )
        item_no = '10'
        material = 'MAT-500045'
      ...
      (
        item_uuid = uuid( '33333333333333333333333333333340' )
        parent_uuid = uuid( '22222222222222222222222222222553' )
        item_no = '10'
        material = 'MAT-300118'
      ...
      (
        item_uuid = uuid( '33333333333333333333333333333350' )
        parent_uuid = uuid( '22222222222222222222222222222609' )
        item_no = '10'
        material = 'MAT-200481'
        description = 'Module connecté X4'
        quantity = 160
    ...
    lt_process_steps = VALUE #(
      (
        step_uuid = uuid( 'AAAAAAAA111111111111111111111001' )
        parent_uuid = uuid( '22222222222222222222222222222281' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA111111111111111111111002' )
        parent_uuid = uuid( '22222222222222222222222222222281' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA111111111111111111111003' )
        parent_uuid = uuid( '22222222222222222222222222222281' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA222222222222222222222001' )
        parent_uuid = uuid( '22222222222222222222222222222507' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA222222222222222222222002' )
        parent_uuid = uuid( '22222222222222222222222222222507' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA333333333333333333333001' )
        parent_uuid = uuid( '22222222222222222222222222222553' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA333333333333333333333002' )
        parent_uuid = uuid( '22222222222222222222222222222553' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA333333333333333333333003' )
        parent_uuid = uuid( '22222222222222222222222222222553' )
      ...
      (
        step_uuid = uuid( 'AAAAAAAA444444444444444444444001' )
        parent_uuid = uuid( '22222222222222222222222222222609' )
    ...
    lt_alerts = VALUE #(
      (
        alert_uuid = uuid( '44444444444444444444444444444001' )
        alert_id = 'A-1001'
      ...
      (
        alert_uuid = uuid( '44444444444444444444444444444002' )
        alert_id = 'A-1002'
      ...
      (
        alert_uuid = uuid( '44444444444444444444444444444003' )
        alert_id = 'A-1003'
      ...
      (
        alert_uuid = uuid( '44444444444444444444444444444004' )
        alert_id = 'A-1004'
      ...
      (
        alert_uuid = uuid( '44444444444444444444444444444005' )
        alert_id = 'A-1005'
    ...
    lt_kpis = VALUE #(
      (
        snapshot_uuid = uuid( '11111111111111111111111111111111' )
    ...
    lt_top_customers = VALUE #(
      (
        topcust_uuid = uuid( '99999999111111111111111111111001' )
        customer_id = '10000045'
        customer_name = 'Groupe Nova Retail'
        revenue = '184500.00'
        currency = 'EUR'
      ...
      (
        topcust_uuid = uuid( '99999999111111111111111111111002' )
        customer_id = '10000072'
        customer_name = 'Atelier Martin Pro'
        revenue = '142800.00'
        currency = 'EUR'
      ...
      (
        topcust_uuid = uuid( '99999999111111111111111111111003' )
        customer_id = '10000118'
        customer_name = 'Medialux Distribution'
        revenue = '98600.00'
        currency = 'EUR'
      ...
      (
        topcust_uuid = uuid( '99999999111111111111111111111004' )
        customer_id = '10000201'
        customer_name = 'Senso Habitat'
        revenue = '76300.00'
        currency = 'EUR'
    ...
    lt_top_materials = VALUE #(
      (
        topmat_uuid = uuid( '99999999222222222222222222222001' )
        material = 'MAT-100024'
        description = 'Kit installation premium'
      ...
      (
        topmat_uuid = uuid( '99999999222222222222222222222002' )
        material = 'MAT-200481'
        description = 'Module connecté X4'
      ...
      (
        topmat_uuid = uuid( '99999999222222222222222222222003' )
        material = 'MAT-300118'
        description = 'Pack maintenance annuel'
        category = 'Service'
        quantity = 86
      ...
      (
        topmat_uuid = uuid( '99999999222222222222222222222004' )
        material = 'MAT-500045'
        description = 'Armoire technique standard'
        category = 'Équipement'
        quantity = 52
    ...
    lt_revenue_month = VALUE #(
      (
        revmon_uuid = uuid( '55555555555555555555555555555001' )
        month_text = 'Jan'
        revenue = '610000.00'
        currency = 'EUR'
        sort_no = 1
      ...
      (
        revmon_uuid = uuid( '55555555555555555555555555555002' )
        month_text = 'Fév'
        revenue = '690000.00'
        currency = 'EUR'
        sort_no = 2
      ...
      (
        revmon_uuid = uuid( '55555555555555555555555555555003' )
        month_text = 'Mar'
        revenue = '735000.00'
        currency = 'EUR'
        sort_no = 3
      ...
      (
        revmon_uuid = uuid( '55555555555555555555555555555004' )
        month_text = 'Avr'
        revenue = '804000.00'
        currency = 'EUR'
        sort_no = 4
      ...
      (
        revmon_uuid = uuid( '55555555555555555555555555555005' )
        month_text = 'Mai'
        revenue = '842000.00'
        currency = 'EUR'
        sort_no = 5
    ...
    lt_revenue_customer = VALUE #(
      (
        revcust_uuid = uuid( '66666666666666666666666666666001' )
        customer_name = 'Nova Retail'
        revenue = '184500.00'
        currency = 'EUR'
      )
      (
        revcust_uuid = uuid( '66666666666666666666666666666002' )
        customer_name = 'Atelier Martin'
        revenue = '142800.00'
        currency = 'EUR'
      )
      (
        revcust_uuid = uuid( '66666666666666666666666666666003' )
        customer_name = 'Medialux'
        revenue = '98600.00'
        currency = 'EUR'
      )
      (
        revcust_uuid = uuid( '66666666666666666666666666666004' )
        customer_name = 'Senso Habitat'
        revenue = '76300.00'
        currency = 'EUR'
      )
    ...
    lt_revenue_sales_org = VALUE #(
      (
        revsorg_uuid = uuid( '77777777777777777777777777777001' )
        sales_org = 'FR01'
        revenue = '482000.00'
        currency = 'EUR'
      )
      (
        revsorg_uuid = uuid( '77777777777777777777777777777002' )
        sales_org = 'FR02'
        revenue = '214000.00'
        currency = 'EUR'
      )
      (
        revsorg_uuid = uuid( '77777777777777777777777777777003' )
        sales_org = 'DE01'
        revenue = '146000.00'
        currency = 'EUR'
      )
    ...
    lt_operational_trend = VALUE #(
      (
        optrend_uuid = uuid( '88888888888888888888888888888001' )
        week_text = 'S18'
        delays = 8
        open_orders = 96
      )
      (
        optrend_uuid = uuid( '88888888888888888888888888888002' )
        week_text = 'S19'
        delays = 11
        open_orders = 108
      )
      (
        optrend_uuid = uuid( '88888888888888888888888888888003' )
        week_text = 'S20'
        delays = 17
        open_orders = 128
      )
      (
        optrend_uuid = uuid( '88888888888888888888888888888004' )
        week_text = 'S21'
        delays = 13
        open_orders = 117
      )
